package org.firstinspires.ftc.teamcode.common.drive.pedroPathing.tuning;

import com.acmerobotics.dashboard.config.Config;

import org.firstinspires.ftc.teamcode.common.drive.pedroPathing.util.KalmanFilterParameters;
...
import org.firstinspires.ftc.teamcode.common.drive.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.common.drive.pedroPathing.util.CustomPIDFCoefficients;
...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "dtFrontLeftMotor";
    public static String leftRearMotorName = "dtBackLeftMotor";
    public static String rightFrontMotorName = "dtFrontRightMotor";
    public static String rightRearMotorName = "dtBackRightMotor";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 72.9055211634;
    private static double yMovement = 56.5755280304;
    ...
    public static double mass = 13.1;
    ...
    public static double forwardZeroPowerAcceleration = -20.2177436105;//-41.7177436105;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70.1745226759;
