...
public class FollowerConstants {
    ...
    private static double xMovement = 73.91323;
    private static double yMovement = 47.46637;
    ...
    public static CustomPIDFCoefficients smallHeadingPIDFCoefficients = new CustomPIDFCoefficients(
            6, // 5 // try 2.5 - 3.5, maybe too aggressive
            0,
            0.15, // 0.08
            0);
    ...
    public static double mass = 14.42; //31.8
    ...
    public static double forwardZeroPowerAcceleration = -29.72329;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -80.18579;
    ...
    public static double zeroPowerAccelerationMultiplier = 2.5; // previous value 4, caused wheel slippage
