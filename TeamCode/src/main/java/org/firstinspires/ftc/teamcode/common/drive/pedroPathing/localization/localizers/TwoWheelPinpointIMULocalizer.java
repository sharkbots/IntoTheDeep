...
import org.firstinspires.ftc.teamcode.common.drive.pedroPathing.localization.GoBildaPinpointDriver;
...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 1/505.316944406;//505.316944406; //35521.2631007203;
    // 19.89436789ticks = 1mm
    // 505.316944406ticks = 1in

    public static double STRAFE_TICKS_TO_INCHES = 1/505.316944406;//505.316944406;
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(85.33398/25.4, -60.05000/25.4, 0);
        strafeEncoderPose = new Pose(85.81757/25.4, 3.56571/25.4, Math.toRadians(90));
        //forwardEncoderPose = new Pose(0,  20, Math.toRadians(0));
        //strafeEncoderPose = new Pose(3, 0, Math.toRadians(90));
//        forwardEncoderPose = new Pose(0, 0, 0);
//        strafeEncoderPose = new Pose(0, 0, Math.toRadians(90));

        hardwareMap = map;

        pinpoint = hardwareMap.get(GoBildaPinpointDriver.class, "pinpoint_sensor");
        pinpoint.resetPosAndIMU();


        // TODO: replace these with your encoder ports
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "liftTopMotor"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "extendoMotor"));
