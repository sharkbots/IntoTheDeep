...
public class LiftSubsystemTest extends CommandOpMode {
    ...
    public void initialize() {
        ...
        gamepadEx.getGamepadButton(GamepadKeys.Button.B)
                .whenPressed(new InstantCommand(() -> lift.updateState(LiftSubsystem.LiftState.DEPOSIT_HIGH_BASKET)));

        // Map button Y to set lift state to DEPOSIT_HIGH_RUNG
        gamepadEx.getGamepadButton(GamepadKeys.Button.Y)
                .whenPressed(new InstantCommand(() -> lift.updateState(LiftSubsystem.LiftState.DEPOSIT_HIGH_RUNG)));
